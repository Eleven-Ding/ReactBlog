...
export default memo(function PreView() {
  ...
  return (
    <PreviewWrapper point={point} show={showPreViewCpn} ratio={ratio} className="shy-preview">
      ...
      {
          currentImgIndex?.includes('.mp4')? <video  ref={imgRef} onMouseDown={handleMouseDown} onMouseUp={mouseUp} src={currentImgIndex}></video>:<img ref={imgRef} onMouseDown={handleMouseDown} onMouseUp={mouseUp} src={currentImgIndex} alt="" />
      } 
